...
def sendRequest(blood, location, patient, contact, Urgency):
    ...
    app.config['MAIL_USERNAME'] = 'mitrahelp21@gmail.com'
    app.config['MAIL_DEFAULT_SENDER'] = 'mitrahelp21@gmail.com'
    app.config['MAIL_PASSWORD'] = 'fmyr rbzw zemi dood'
    mail = Mail(app)
    msg = Message(f"Urgent Blood Donation Needed - {blood} in {location}", sender='mitrahelp21@gmail.com', recipients=["aadrshgujar888@gmail.com"])
    msg.body = f"""
Dear Donor,
